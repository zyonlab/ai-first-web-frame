...
import { referralsLayoutCss } from "../src/render";

export { metadata } from "../src/metadata";

/**
 * Theme + i18n asset tags for the referrals page. The design-system is the
 * single CSS source (spine §11): we inject the base reset, all theme variable
 * blocks (light + dark, attribute-driven), and the referrals layout CSS through
