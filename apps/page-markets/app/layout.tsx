...
import { marketsLayoutCss } from "../src/gridStyles";
...
/**
 * Theme + i18n asset tags for the markets page. The design-system is the single
 * CSS source (spine §11): we inject the base reset, all theme variable blocks
 * (light + dark, attribute-driven), the markets layout CSS, and the shared
    ...
    i18n: [
      {
        locale: "en-US",
        namespace: "markets",
        messages: { title: "MVP Perps — Markets" },
        order: 6,
      },
      {
        locale: "zh-CN",
        namespace: "markets",
        messages: { title: "MVP 永续 — 市场" },
        order: 7,
      },
    ],
  }),
...
export default async function RootLayout({
  ...
  return (
    <html lang={LOCALE_LANG[locale]} data-theme={resolvedTheme}>
      ...
      <body>
        <AppNav currentPath="/markets" theme={resolvedTheme} locale={locale} />
        {children}
      </body>
    </html>
  );
