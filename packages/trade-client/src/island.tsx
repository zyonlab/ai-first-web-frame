 ...
 * ```
 *
 * `@mvp/trade-client` is the ONLY package that ships React to the browser. It
 * reads the snapshot, looks the island up in the registry, and hydrates it
 * with `react-dom/client`. Every fragment agent MUST emit matching markup;
 * this shape is frozen and consumed unchanged by the page/fragment agents.
 */
